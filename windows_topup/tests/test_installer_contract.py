...
class InstallerContractTests(unittest.TestCase):
    def test_setup_fails_closed_until_database_is_verified(self):
        ...
        self.assertIn('$env:ProgramData "SmartDispenser\\Topup"', script)
        ...
        self.assertIn("topup-prerequisites-ready.marker", setup)
        ...
        self.assertIn("topup-installer-database.log", script)
